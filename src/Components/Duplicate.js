...
export function Duplicate(props) {
    ...
    const bccX = props.bcc
    const societyX = props.society
    const producerX = props.producer
    const toDate = props.toDate
    const fromDate = props.fromDate
    console.log("assdasd----", producerX)

    const headquarters = bccX.hq_name
    const bccName = bccX.bcc_name
    const societyName = societyX.society_name
    ...
    }, [headquarters, bccName, societyName, producerX]);
    ...
    }, [headquarters, bccName, societyName]);
    ...
    }, [fromDate, toDate, headquarters, bccName, societyName]);
